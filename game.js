...
class Game {
    ...
    startLiteracyMode(stage) {
        ...
        if (sourceEl) {
            sourceEl.innerText = this.literacyData.source || "";
        }
    ...
    togglePassageModal(show) {
        if (show) {
            ...
            // Display source in modal if available
            const sourceEl = document.getElementById('modal-passage-source');
            if (sourceEl) {
                sourceEl.innerText = this.literacyData.source || "";
            }
